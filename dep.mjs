            ...
            f = i.DES = o.extend({
                _doReset: function() {
                    ...
                    for (var o = this._subKeys = [], i = 0; i < 16; i++) {
                        var c = o[i] = [],
                            l = u[i];
                        for (n = 0; n < 24; n++) c[n / 6 | 0] |= e[(a[n] - 1 + l) % 28] << 31 - n % 6, c[4 + (n / 6 | 0)] |= e[28 + (a[n + 24] - 1 + l) % 28] << 31 - n % 6;
                ...
                _doCryptBlock: function(t, e, n) {
                    ...
                    for (var r = 0; r < 16; r++) {
                        for (var o = n[r], i = this._lBlock, s = this._rBlock, a = 0, u = 0; u < 8; u++) a |= c[u][((s ^ o[u]) & l[u]) >>> 0];
